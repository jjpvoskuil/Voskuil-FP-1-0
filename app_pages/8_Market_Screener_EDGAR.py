...
from edgar_scan_core import (
    EDGAR_FACTS_CACHE_NUM_SHARDS, EDGAR_FACTS_CACHE_MAX_AGE_DAYS,
    load_facts_cache_shards as _load_facts_cache_shards_core,
...
def _load_facts_cache_shards(tickers: list) -> tuple:
    """Thin wrapper: injects this app's GitHub-Contents-API read (Streamlit
...
def _save_facts_cache_updates(updates: dict) -> list:
    """Thin wrapper: injects this app's GitHub-Contents-API read/write
    (Streamlit secrets-backed) into the shared, framework-agnostic core
    function. See edgar_scan_core.save_facts_cache_updates() for the actual
    logic/docstring."""
    return _save_facts_cache_updates_core(updates, github_get_json, github_put_json)
